...
Reasonledger was developed and first disclosed as **AI-Native Notation (ANN)**. The earlier name is retained in the provenance record for citation and priority; see [`NOTICE`](./NOTICE) and the specification's "Version lineage" section.
